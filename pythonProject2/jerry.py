...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.right_recommend_layout.addWidget(self.right_recommend_LineEdit, 0, 0, 6, 11)
        ...
        self.right_recommend_layout.addWidget(right_recommend_LineEdit2, 0, 0, 6, 11)
        right_recommend_LineEdit2.setContentsMargins(16, 8, 16, 8)
        ...
        self.right_layout.addWidget(label_progress, 2, 7, 2, 1)
        ...
        self.right_newsong_layout.addWidget(self.pushButton_5, 16, 10, 6, 6, QtCore.Qt.AlignCenter)
        self.right_newsong_layout.setContentsMargins(30, 10, 30, 20)
        ...
        self.main_layout.addWidget(down_LineEdit, 17, 0, 15, 12)
        down_LineEdit.setContentsMargins(20, 5, 20, 0)
        ...
        # 左下的部件
        self.down_widget.setContentsMargins(40, 25, 20, 20)
        ...
        self.down_widget.setGeometry(100, 110, 400, 300)
